...
const getGrossProfit = carObj => {
    carReport.profit2017 += carObj.gross_profit;
};

const cars17 = cars.filter((car) => {
    const year = car.purchase_date.split("-")[0];
    if (year == 2017) return car;
});

cars17.forEach(car => getGrossProfit(car));
...
carReport.popularMonth = [highSalesMonths[0][1], highSalesMonths.shift, highSalesMonths];
console.log(highSalesMonths);
